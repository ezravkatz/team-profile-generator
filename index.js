  ...
  return inquirer
    .prompt([
      ...
      },
      {
        ...
        validate: (nameInput) => {
          if (nameInput) {
            ...
            console.log("Error! Please enter a name for the employee's entry.");
            return false;
          }
        },
      },
      {
        ...
        validate: (nameInput) => {
          if (isNaN(nameInput)) {
            console.log("Error! Please enter a name for the employee entry.");
            return false;
          } else {
            return true;
          }
      ...
      },
      {
        ...
        validate: (email) => {
          ...
          if (valid) {
            ...
            console.log(
              "Error! Please enter a valid email address for the employee entry."
            );
            return false;
          }
        },
    ...
    .then((teamData) => {
      let { name, ID, email, position, github, school, confirmAdd } = teamData;
      let employee;
...
const createFile = (data) => {
  fs.createFile("./dist/index.html", data, (err) => {
    if (err) {
      ...
      console.log(
        "Your team profile has been generated! You can find it by checking the index.html file."
      );
    }
  });
};
